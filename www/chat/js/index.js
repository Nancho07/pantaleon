...
// Set Name
    ...
    function setName2(name) {
        $.trim(name) === '' || $.trim(name) === null ? name = 'Hernan Guevara' : name = name;
        $('#chat > h1').text(name);
